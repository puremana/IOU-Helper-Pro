...
{
    class TextConsole : System.Windows.Forms.TextBox
    {
        public void start(TextConsole console)
        {
            ...
            Console.WriteLine("Got this to actually write like a console.");
            Console.WriteLine("Elly is cute");
            Console.WriteLine("Cute for a nerd!");
